...
export const GLOBAL_DYNAMIC_SETTINGS_FORM_VISIBLE =
...
export const EMPLOYEE_REPORTER_DATA = "employee_reporter_date";

export const TODAYS_BIRTHDAY_LIST = "todays_birthday_list";
