...
const Login_two = ({ isShowLogin, show, handleMethod, hide }) => {
  //for fb login
  ...
  function verifyUser() {
    ...
    var config = {
      method: "post",
      url: BACKEND_BASE_URL + "/users/activation/",
      headers: {
        "Content-Type": "application/json",
      },
      data: data,
  ...
  function loginUser() {
    ...
    var config = {
      method: "post",
      url: BACKEND_BASE_URL + "/token/login/",
      headers: {
        "Content-Type": "application/json",
      },
      data: data,
  ...
  return (
    ...
    >
      ...
      <div className="logininner logininner-edit">
